...
export function AISteward({ location, userProfile }: AIStewardProps) {
  ...
  return (
    <div className="bg-stone-900 border border-emerald-500/20 rounded-[32px] p-8 mt-8 relative overflow-hidden">
      ...
      <div className="relative z-10">
        {loading ? (
          ...
          <p className="text-sm text-stone-300 leading-relaxed italic border-l-2 border-emerald-500/30 pl-4">
            "{advice}"
          </p>
        )}
      </div>
